...
mixin _$FeedState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<PostModel> items) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<PostModel> items)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<PostModel> items}) : _items = items;
...
abstract class _Loaded implements FeedState {
  const factory _Loaded({required final List<PostModel> items}) = _$LoadedImpl;
